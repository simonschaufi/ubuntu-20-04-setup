...
curl \
    -L "https://github.com/docker/compose/releases/download/v2.40.3/docker-compose-$(uname -s)-$(uname -m)" \
...
#  sed -i "s/;cgi.fix_pathinfo=1/cgi.fix_pathinfo=0/" /etc/php/7.0/fpm/php.ini This is required for TYPO3!
...
#  sed -i "s/;cgi.fix_pathinfo=1/cgi.fix_pathinfo=0/" /etc/php/7.1/fpm/php.ini This is required for TYPO3!
...
#  sed -i "s/;cgi.fix_pathinfo=1/cgi.fix_pathinfo=0/" /etc/php/7.2/fpm/php.ini This is required for TYPO3!
...
#  sed -i "s/;cgi.fix_pathinfo=1/cgi.fix_pathinfo=0/" /etc/php/7.3/fpm/php.ini This is required for TYPO3!
...
#  sed -i "s/;cgi.fix_pathinfo=1/cgi.fix_pathinfo=0/" /etc/php/7.4/fpm/php.ini This is required for TYPO3!
...
#  sed -i "s/;cgi.fix_pathinfo=1/cgi.fix_pathinfo=0/" /etc/php/8.3/fpm/php.ini This is required for TYPO3!
  sed -i "s/;max_input_vars = .*/max_input_vars = 1500/" /etc/php/8.3/fpm/php.ini
  sed -i "s/max_execution_time = .*/max_execution_time = 240/" /etc/php/8.3/fpm/php.ini
...
#  sed -i "s/;cgi.fix_pathinfo=1/cgi.fix_pathinfo=0/" /etc/php/8.4/fpm/php.ini This is required for TYPO3!
  sed -i "s/;max_input_vars = .*/max_input_vars = 1500/" /etc/php/8.4/fpm/php.ini
  sed -i "s/max_execution_time = .*/max_execution_time = 240/" /etc/php/8.4/fpm/php.ini
  ...
  sed -i "s/listen\.owner.*/listen.owner = ${USER}/" /etc/php/8.4/fpm/pool.d/www.conf
  sed -i "s/listen\.group.*/listen.group = ${USER}/" /etc/php/8.4/fpm/pool.d/www.conf
  ...
  /usr/local/bin/composer global require simonschaufi/neos-installer
  /usr/local/bin/composer global require simonschaufi/typo3-installer
