...
```bash
wget https://github.com/RocketChat/Rocket.Chat.Electron/releases/download/4.10.1/rocketchat-4.10.1-linux-amd64.deb
sudo apt install -y ./rocketchat-4.10.1-linux-amd64.deb && rm rocketchat-4.10.1-linux-amd64.deb
```
...
```bash
wget https://github.com/ONLYOFFICE/DesktopEditors/releases/download/v9.4.0/onlyoffice-desktopeditors_amd64.deb
